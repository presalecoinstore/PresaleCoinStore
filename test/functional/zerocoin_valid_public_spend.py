...
from fake_stake.base_test import PreSaleCoinStore_FakeStakeTest

class zPSCSValidCoinSpendTest(PreSaleCoinStore_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zPSCSs..." % DENOM_TO_USE)
