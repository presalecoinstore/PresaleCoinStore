...
/** Utility functions used by the PreSaleCoinStore Qt UI.
 */
namespace GUIUtil
{
...
// Render PreSaleCoinStore addresses in monospace font
...
// Parse "presalecoinstore:" URI into recipient object, return true on successful parsing
