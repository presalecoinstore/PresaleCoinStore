...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("PreSaleCoinStore Core"),
     ...
     * override -datadir in the presalecoinstore.conf file in the default data directory
     * (to be consistent with presalecoinstored behavior)
     */
    if (dataDir != getDefaultDataDirectory())
