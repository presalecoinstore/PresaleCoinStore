                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzPSCSPathCustom = GetArg("-zpscsbackuppath", "");
    ...
    if(!strzPSCSPathCustom.empty()) {
        ui->wallet_customzpscsbackuppath->setText(QString::fromStdString(strzPSCSPathCustom));
        ui->wallet_customzpscsbackuppath_label->setVisible(true);
        ui->wallet_customzpscsbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzPSCSPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the PreSaleCoinStore RPC console.") + "<br>" +
