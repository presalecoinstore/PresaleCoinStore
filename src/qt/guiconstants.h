...
#define QAPP_ORG_NAME "PreSaleCoinStore"
#define QAPP_ORG_DOMAIN "presalecoinstore.org"
#define QAPP_APP_NAME_DEFAULT "PreSaleCoinStore-Qt"
#define QAPP_APP_NAME_TESTNET "PreSaleCoinStore-Qt-testnet"
