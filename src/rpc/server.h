...
/**
 * PreSaleCoinStore RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue DoZpscsSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzpscsseed(const UniValue& params, bool fHelp);
extern UniValue getzpscsseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzpscs(const UniValue& params, bool fHelp);
extern UniValue dzpscsstate(const UniValue& params, bool fHelp);
