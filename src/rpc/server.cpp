...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop PreSaleCoinStore server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "PreSaleCoinStore server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PreSaleCoinStore features */
        {"presalecoinstore", "listmasternodes", &listmasternodes, true, true, false},
        {"presalecoinstore", "getmasternodecount", &getmasternodecount, true, true, false},
        {"presalecoinstore", "masternodeconnect", &masternodeconnect, true, true, false},
        {"presalecoinstore", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"presalecoinstore", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"presalecoinstore", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"presalecoinstore", "masternodecurrent", &masternodecurrent, true, true, false},
        {"presalecoinstore", "masternodedebug", &masternodedebug, true, true, false},
        {"presalecoinstore", "startmasternode", &startmasternode, true, true, false},
        {"presalecoinstore", "createmasternodekey", &createmasternodekey, true, true, false},
        {"presalecoinstore", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"presalecoinstore", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"presalecoinstore", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"presalecoinstore", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"presalecoinstore", "getmasternodescores", &getmasternodescores, true, true, false},
        {"presalecoinstore", "preparebudget", &preparebudget, true, true, false},
        {"presalecoinstore", "submitbudget", &submitbudget, true, true, false},
        {"presalecoinstore", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"presalecoinstore", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"presalecoinstore", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"presalecoinstore", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"presalecoinstore", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"presalecoinstore", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"presalecoinstore", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"presalecoinstore", "checkbudgets", &checkbudgets, true, true, false},
        {"presalecoinstore", "mnsync", &mnsync, true, true, false},
        {"presalecoinstore", "spork", &spork, true, true, false},
        {"presalecoinstore", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzpscsseed", &getzpscsseed, false, false, true},
        {"zerocoin", "setzpscsseed", &setzpscsseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzpscs", &searchdzpscs, false, false, true},
        {"zerocoin", "dzpscsstate", &dzpscsstate, false, false, true},
...
{
    return "> presalecoinstore-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:32560/\n";
}
