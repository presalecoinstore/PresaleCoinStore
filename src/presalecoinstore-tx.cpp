...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Pivx Core presalecoinstore-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  presalecoinstore-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded presalecoinstore transaction") + "\n" +
                               "  presalecoinstore-tx [options] -create [commands]   " + _("Create hex-encoded presalecoinstore transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded presalecoinstore transaction
