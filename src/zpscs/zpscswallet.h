...
#ifndef PreSaleCoinStore_ZPSCSWALLET_H
#define PreSaleCoinStore_ZPSCSWALLET_H
...
public:
    CzPSCSWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZPSCS(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZPSCS(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //PreSaleCoinStore_ZPSCSWALLET_H
