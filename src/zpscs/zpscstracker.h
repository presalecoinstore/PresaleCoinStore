...
#ifndef PreSaleCoinStore_ZPSCSTRACKER_H
#define PreSaleCoinStore_ZPSCSTRACKER_H
...
public:
    CzPSCSTracker(std::string strWalletFile);
    ~CzPSCSTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzPSCSWallet* zPSCSWallet = NULL);
...
#endif //PreSaleCoinStore_ZPSCSTRACKER_H
