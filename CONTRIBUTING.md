Contributing to PreSaleCoinStore Core
============================

The PreSaleCoinStore Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/PreSaleCoinStore-project/PreSaleCoinStore/blob/master/doc/translation_process.md)
...
The following applies to code changes to the PreSaleCoinStore Core project, and is not to be
confused with overall PreSaleCoinStore Network Protocol consensus changes.

Whether a pull request is merged into PreSaleCoinStore Core rests with the project merge
...
Patches that change PreSaleCoinStore consensus rules are considerably more involved than
...
Where a patchset proposes to change the PreSaleCoinStore consensus, it must have been
...
The project leader is the release manager for each PreSaleCoinStore Core release.
